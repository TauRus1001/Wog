...
function event() {
    ...
    var e = new Date;
    t.write(temp_table1),
    t.write('<form action="wog_act.php" method="post" target="mission">'),
    t.write("<tr><td>站長要考驗大家是否有認真在玩</td></tr>"),
    t.write("<tr><td>請注意...必須用半形字 及 數目字 1-9 輸入驗證碼 , 每人有5次機會</td></tr>"),
    t.write('<tr><td colspan="2"><img src="wog_etc.php?f=confirm&time=' + e.getTime() + '"></td></tr>'),
    t.write('<tr><td>請輸入安全驗證碼:<input type="text" name="sec_code" size="8"></td></tr>'),
    t.write('<tr><td colspan="2"><input class="text" type="button" value="填好答案了,放我過關吧!!" onClick="parent.foot_trun(\'event\',\'\',this.form.sec_code.value,\'\')" style="' + sbutton + '"></td></tr>'),
    t.write("</form>"),
    t.write(temp_table2)
}
