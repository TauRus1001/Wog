...
async function armAll(){
	...
	let e = parent.wog_view.document;
	switch (parseInt(itemListSelect)){
		case 0:
			itemsList = ["7229","7230","7231","7232","7233","7064","7065","7066","7067"];
			break;
		case 1:
			itemsList = ["7189","7190","7191","7192","7064","7065","7066","7067"];
			break;
		default:
			e.body.innerHTML="";
			e.write(temp_table1);
		    e.write('<tr bgcolor="#4B689E"><td>選擇錯誤</td></tr>');
		    e.write(temp_table2);
			return;
	}
	...
	for (let i = 0; i<itemsList.length;i++){
    	...
    	await parent.armItem(itemsList[i]);
	}
	await parent.sleep(200);
	delete itemList;
	e.body.innerHTML="";
